...
#sys.path.append('/Users/juliamarlene/Sonstiges/ged_sinkhorn')
...
def run(df, T_max, T_param):
    ...
    #Acyclic dataset
    path_dataset = 'Users/juliamarlene/Documents/Studium Master/NS_Projekt/Code/deepged/data/Acyclic/dataset_bps.ds'

    #MAO dataset (with edge labels)
    #path_dataset = 'Users/juliamarlene/Documents/Studium Master/NS_Projekt/Code/deepged/data/MAO/dataset.ds'
    ...
    if rna_tree == True:
        Gs = []
        paths = glob.glob("Users/juliamarlene/Documents/Studium Master/NS_Projekt/Code/deepged/data/RNA_trees/*/1.txt")
        for path in paths:

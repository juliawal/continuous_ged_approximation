"""
notes:
Python 3.11.3 ('base') /opt/homebrew/anaconda3/bin/python
"""
...
from deepged.deepged.label_manager import compute_extended_labels, build_node_dictionnary
...
def run(df, T_max, T_param):
    ...
    #Acyclic dataset
    #path_dataset = '/Users/juliamarlene/Documents/Studium_aktuell/NS_Projekt/Code/deepged/data/Acyclic/dataset_bps.ds'

    #MAO dataset (with edge labels)
    #path_dataset = '/Users/juliamarlene/Documents/Studium_aktuell/NS_Projekt/Code/deepged/data/MAO/dataset.ds'
    ...
    if rna_tree == True:
        Gs = []
        paths = glob.glob("/Users/juliamarlene/Documents/Studium_aktuell/NS_Projekt/Code/deepged/data/RNA_trees/*/1.txt")
        for path in paths:
        ...
        node_labels, nb_edge_labels = build_node_dictionnary(Gs, node_label, edge_label)
    ...
    for i in range(1,len(Gs_pairs)):
        ...
        S = sink_utils.cost_to_sim_exp(torch.from_numpy(C).float(), T_param, T_max)
        ...
        df.loc[len(df)] = [lb_h, lb_sh, lb_sh_projection, ub_h, ub_sh, r_e_lb_sh, r_e_lb_sh_projection, r_e_ub, e_sh, rt_h, rt_sh, rt_sh_projection, T_max, T_param]
